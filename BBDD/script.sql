...
CREATE TABLE final_LIKES_MENSAJE(
    IDMENSAJE int(10),
    NICKNAME VARCHAR(20),

    CONSTRAINT PK_LIKES_MENSAJE PRIMARY KEY (IDMENSAJE,NICKNAME),
    CONSTRAINT FK_IDMENSAJE FOREIGN KEY (IDMENSAJE) REFERENCES final_MENSAJE(IDMENSAJE) ON DELETE CASCADE,
...
INSERT INTO final_EJERCICIO_RUTINA VALUES (2,001);
INSERT INTO final_EJERCICIO_RUTINA VALUES (2,002);
INSERT INTO final_EJERCICIO_RUTINA VALUES (2,003);
